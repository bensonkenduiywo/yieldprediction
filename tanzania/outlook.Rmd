...
library(mapview)
tmap_mode("view")
 map_a <- tm_shape(tza2, name="2023 OND Maize yield (MT/ha)") +
  tm_fill(col= "gwad.OND_2023",   title="2023 OND Yield (MT/ha)", textNA = "No data", n=5) +
   tm_facets(sync = TRUE, ncol = 2, nrow=2) +
   tm_layout(title.size =5, panel.label.size=6)+
   tm_format("World")
 
 map_b <- tm_shape(tza1, name="2022 OND Maize yield (MT/ha)") +
  tm_fill(col= "gwad.OND",   title="2022 OND Yield (MT/ha)", textNA = "No data", n=5) +
   tm_facets(sync = TRUE, ncol = 2, nrow=2) +
   tm_layout(title.size =5, panel.label.size=6)+
   tm_format("World")

 map_c <- tm_shape(tza1, name="2022 MAM Maize yield (MT/ha)") +
  tm_fill(col= "gwad.MAM",   title="2022 MAM Yield (MT/ha)", textNA = "No data", n=5) +
   tm_facets(sync = TRUE, ncol = 2, nrow=2) +
   tm_layout(title.size =5, panel.label.size=6)+
   tm_format("World")
 
 map_d <- tm_shape(tza1, name="2022 LR Maize yield (MT/ha)") +
  tm_fill(col= "gwad.LR",   title="2022 LR Yield (MT/ha)", textNA = "No data", n=5) +
   tm_facets(sync = TRUE, ncol = 2, nrow=2) +
   tm_layout(title.size =5, panel.label.size=6)+
   tm_format("World")
