...
map_a <- tm_shape(tza, name="Average yield (MT/ha) per Region") +
  tm_polygons(col=c("gwad.OND", "gwad.MAM", "gwad.LR", "lai.LR"),   title=c("OND Yield (MT/ha)", "MAM Yield (MT/ha)", "LR Yield (MT/ha)", "LR LAI")) +
...
Visualize trends for the last 15 years.
