...
year <- 2022
temp <- rh[, c("Region", "date", "Season", "gwad")]
temp <- reshape(temp, idvar = c("Region","date"), timevar = "Season", v.names  = "gwad",direction = "wide")
...
map_a <- tm_shape(tza, name="Average yield (MT/ha) per Region") +
  tm_polygons(col=c("gwad.OND", "gwad.MAM", "gwad.LR"),  n=5, title=c("OND Yield (MT/ha)", "MAM Yield (MT/ha)", "LR Yield (MT/ha)")) +
