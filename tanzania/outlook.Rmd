...
year <- 2022
temp <- rh[, c("Region", "date", "gwad", "lai", "Season")]
...
tmap_mode("view")
 map_a <- tm_shape(tza, name="Average yield (MT/ha) per Region") +
  tm_fill(col=c("gwad.OND", "gwad.MAM", "gwad.LR", "lai.LR"),   title=c("OND Yield (MT/ha)", "MAM Yield (MT/ha)", "LR Yield (MT/ha)", "LR LAI"), breaks = seq(0.3,4.5,1)) +
...
tmap_save(map_a, filename="TZ_Yields_2022.png")
