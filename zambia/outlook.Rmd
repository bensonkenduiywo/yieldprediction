...
Zambia's Ministry of Agriculture (MoA) maize forecasts.
...
production <- aggregate(Production~PROVINCE, data=zmb@data, sum, na.rm=T)

knitr::kable(production, caption = "Zambia's provincial Maize preduction in (MT)")
