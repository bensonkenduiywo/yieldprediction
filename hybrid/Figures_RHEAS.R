...
rheasmap <- tmap_arrange(map1, map2, map3, legend.map, map4, map5, map6, leg.ubRMSE,
                       map7, map8, map9, leg.MBE, ncol =4) 
#rfhmap
tmap_save(rheasmap, scale =1.6, dpi= 600, height=8, width=8, units = 'in', filename=paste0(root, "Results/RHEAS_Spatial_Distribution.png"))
